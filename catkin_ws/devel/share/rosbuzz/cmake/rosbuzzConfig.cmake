...
if("TRUE" STREQUAL "TRUE")
  set(rosbuzz_SOURCE_PREFIX /home/sunkur/catkin_ws/src/drones/src/rosbuzz)
  set(rosbuzz_DEVEL_PREFIX /home/sunkur/catkin_ws/devel)
  set(rosbuzz_INSTALL_PREFIX "")
  set(rosbuzz_PREFIX ${rosbuzz_DEVEL_PREFIX})
else()
  set(rosbuzz_SOURCE_PREFIX "")
  set(rosbuzz_DEVEL_PREFIX "")
  set(rosbuzz_INSTALL_PREFIX /home/sunkur/catkin_ws/install)
...
if(NOT "/home/sunkur/catkin_ws/devel/include;/home/sunkur/catkin_ws/src/drones/src/rosbuzz/include " STREQUAL " ")
  set(rosbuzz_INCLUDE_DIRS "")
  set(_include_dirs "/home/sunkur/catkin_ws/devel/include;/home/sunkur/catkin_ws/src/drones/src/rosbuzz/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbuzz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sunkur/catkin_ws/src/drones/src/rosbuzz/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosbuzz_NUM_DUMMY_TARGETS)
      set(rosbuzz_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosbuzz::wrapped-linker-option${rosbuzz_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosbuzz_NUM_DUMMY_TARGETS "${rosbuzz_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosbuzz::wrapped-linker-option${rosbuzz_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosbuzz_LIBRARIES "${interface_target_name}")
